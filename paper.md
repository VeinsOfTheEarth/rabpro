...
![rabpro can return statistics for multiple polygons with a single call. Example output from the Full Example notebook where dam-associated [@prior_vote-dams_2022] watersheds in Sri Lanka are delineated and zonal statistics are run for water occurrence, temperature, and precipitation.\label{fig:figure_2}](./docs/paper_fig/figure_2.PNG)
